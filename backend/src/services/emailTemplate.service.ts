  ...
  <div class="email-wrapper">
    ...
    <div class="content">
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
              <tr>
                <td align="center" bgcolor="#2563eb" style="background-color: #2563eb; border-radius: 8px; padding: 18px 40px;">
                  <a href="${data.confirmLink}" style="color: #ffffff; font-family: 'Malgun Gothic', '맑은 고딕', sans-serif; font-size: 16px; font-weight: 600; text-decoration: none; display: inline-block;">일정 선택하기</a>
                </td>
              </tr>
            </table>
          </td>
      ...
      <div style="text-align: center; margin: 40px 0; padding: 30px 0;">
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto; border-collapse: separate; border-spacing: 0;">
          <tr>
            <td align="center" bgcolor="#2563eb" style="background-color: #2563eb; border-radius: 8px; padding: 18px 40px; mso-padding-alt: 18px 40px;">
              <a href="${data.confirmLink}" target="_blank" style="color: #ffffff; font-family: 'Malgun Gothic', '맑은 고딕', 'Apple SD Gothic Neo', sans-serif; font-size: 16px; font-weight: 600; text-decoration: none; display: inline-block; line-height: 1.5; mso-line-height-rule: exactly;">일정 선택하기</a>
            </td>
          </tr>
        </table>
      </div>
